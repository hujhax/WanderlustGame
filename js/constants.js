...
const PHASES = {
    ...
    MINIGAME_DEBUG_MENU: 'MINIGAME_DEBUG_MENU',
...
const CAST = [
    ...
    { name: 'Leichelle Little', firstName: 'Leichelle', actor: 'Leichelle', imgPath: 'images/cast/leichelle.png', noSprites: true }
];
